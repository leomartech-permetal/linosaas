...
// As 5 áreas principais da arquitetura de navegação
...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-[#fafafa] text-[#111111] overflow-hidden font-sans antialiased selection:bg-neutral-200">
      {/* ── BANNER MODO DE TESTE (NO FLUXO NORMAL — NUNCA SOBREPÕE O CONTEÚDO) ── */}
      {IS_TEST_MODE && (
        <div className="w-full h-8 flex-shrink-0 bg-amber-500 text-black text-xs font-semibold tracking-wider flex items-center justify-center gap-2 shadow-xs select-none">
